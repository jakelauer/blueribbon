...
type HomeDataQuery = { readonly contentfulHomePage: { readonly preHero: { readonly raw: string | null } | null, readonly hero: { readonly raw: string | null } | null, readonly backgroundVideos: ReadonlyArray<{ readonly publicUrl: string } | null> | null } | null };
