...
export class ClubForm extends BaseForm implements BaseClub {
	...
	@FormField(`text`, { label: `City`, groupLabel: `Club Information` })
	city?: string;
	...
	@FormField(`longtext`, { label: `About`, groupLabel: `Club Details` })
	about?: string;

	@FormField(`text`, { label: `Homepage URL`, groupLabel: `Club Details` })
	homepage?: string;
